...
if(!app.includes("marker.on('dragend'")||!app.includes('clearTimeout(liveTimer);load(false,true)')||!app.includes('Отпусти метку — обновим рельеф.'))throw Error('final marker terrain rebuild is missing');
